...
class ThreadsImageClientIntegrationTests extends AbstractIntegrationTests {
    private static final AppenderAttachable<ILoggingEvent> LOGGER =
        (Logger) getLogger(ThreadsImageClient.class);
    ...
    void testPublishImage() {
        ...
        threadsImageClient.publishImage(publishMediaRequest())
            .subscribe();
        ...
        await().atMost(Duration.ofSeconds(5))
            .untilAsserted(() -> {
                ...
                assertThat(logs.getFirst().getFormattedMessage())
                    .isEqualTo("zujy [threads-starter] Изображение успешно опубликовано");
            });
    }
